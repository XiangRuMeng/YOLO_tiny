...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'model_data/yolov4_tiny_weights_voc.pth', # yolov4_tiny_weights_coco
        "classes_path"      : 'model_data/voc_classes.txt', # coco_classes
        #---------------------------------------------------------------------#
    ...
    def generate(self, onnx=False):
        ...
        stat(model=self.net, input_size=(3, 416, 416))
        from ptflops import get_model_complexity_info
        get_model_complexity_info(self.net, (3, 416, 416), as_strings=True, print_per_layer_stat=True)
